	...
	public class Dialog : Widget, ButtonListener
	{
		...
		public Dialog(Image theComponentImage, Image theButtonComponentImage, int theId, bool isModal, string theDialogHeader, string theDialogLines, string theDialogFooter, int theButtonMode)
		{
			...
			if (this.mButtonMode == 1 || this.mButtonMode == 2)
			{
				...
				{
					this.mYesButton.mLabel = Dialog.YES_STRING;
					this.mNoButton.mLabel = Dialog.NO_STRING;
				}
				else
				{
					this.mYesButton.mLabel = Dialog.OK_STRING;
					this.mNoButton.mLabel = Dialog.CANCEL_STRING;
				}
			}
		...
		public virtual int GetPreferredHeight(int theWidth)
		{
			...
			if (this.mDialogLines.Length > 0)
			{
				...
				num += this.GetWordWrappedHeight(g, theWidth - this.mContentInsets.mLeft - this.mContentInsets.mRight - this.mBackgroundInsets.mLeft - this.mBackgroundInsets.mRight - 4, this.mDialogLines, this.mLinesFont.GetLineSpacing() + this.mLineSpacingOffset);
				flag = true;
			}
		...
		public override void Draw(Graphics g)
		{
			...
			else
			{
				...
				theDefaultColor..ctor(GlobalMembersDialog.gDialogColors[num, 0], GlobalMembersDialog.gDialogColors[num, 1], GlobalMembersDialog.gDialogColors[num, 2]);
		...
		public static string YES_STRING;
