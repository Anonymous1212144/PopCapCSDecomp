		...
		public override void Draw(Graphics g)
		{
			...
			if (this.mButtonImage == null && this.mDownImage == null)
			{
				...
				if (flag)
				{
					...
					g.DrawString(this.mLabel, num + 1, num2 + 1);
					return;
				}
				if (!this.mFrameNoDraw)
				{
			...
			else
			{
				...
				{
					this.DrawButtonImage(g, this.mOverImage, new TRect(this.mOverRect), 1, 1);
				}
				else
				{
					this.DrawButtonImage(g, this.mButtonImage, new TRect(this.mNormalRect), 1, 1);
				}
				g.SetColor(this.mColors[1]);
				g.DrawString(this.mLabel, num + 1, num2 + 1);
				return;
