...
namespace SexyFramework.Drivers.Graphics
{
	public class BaseXNAStateManager : RenderStateManager
	{
		...
		{
			if (this.mXNABlendState.AlphaSourceBlend != state.AlphaSourceBlend || this.mXNABlendState.AlphaDestinationBlend != state.AlphaDestinationBlend || this.mXNABlendState.ColorDestinationBlend != state.ColorDestinationBlend || this.mXNABlendState.ColorSourceBlend != state.ColorSourceBlend)
			{
				this.mStateDirty = true;
			}
