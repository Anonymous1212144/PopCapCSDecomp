...
namespace SexyFramework.Widget
{
	public class WidgetManager : WidgetContainer
	{
		...
		public void DrawWidgetsTo(Graphics g)
		{
			...
			List<WidgetManager.Pair<Widget, int>> list = this.mDeferredOverlayWidgets;
		...
		public void DeferOverlay(Widget theWidget, int thePriority)
		{
			...
			this.mDeferredOverlayWidgets.Add(new WidgetManager.Pair<Widget, int>(theWidget, thePriority));
		...
		public List<WidgetManager.Pair<Widget, int>> mDeferredOverlayWidgets = new List<WidgetManager.Pair<Widget, int>>();
