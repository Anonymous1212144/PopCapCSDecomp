...
namespace SexyFramework.Widget
{
	public abstract class Widget : WidgetContainer
	{
		...
		{
			this.superSubResize(theX, theY, theWidth, theHeight);
		}
		...
		public void WidgetDrawOverlay(Graphics g, int thePriority)
		{
			this.DrawOverlay(g, thePriority);
		}
