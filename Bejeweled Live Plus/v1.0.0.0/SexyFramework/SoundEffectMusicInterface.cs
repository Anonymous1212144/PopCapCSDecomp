...
namespace SexyFramework
{
	public class SoundEffectMusicInterface : MusicInterface
	{
		...
		{
			if (this.m_isUserMusicOn || MediaPlayer.State == 2)
			{
				return;
			}
			if (this.m_CurrSong != null)
		...
		public override void Update()
		{
			...
			else if (this.mCurState == MusicInterface.EMusicInterfaceState.State_UserMusicStopedOutGame && this.m_isUserMusicOn && MediaPlayer.State != 1 && this.m_onDeactive && this.m_onServiceDeactive && this.mUpdateCount > 1)
			{
				this.m_onDeactive = false;
		...
		public override void OnServiceActived()
		{
			...
			if (this.mActiveCount == 1 && this.m_isUserMusicOn && MediaPlayer.State != 1)
			{
		...
		public override void OnMediaPlayerStateChanged(object sender, EventArgs e)
		{
			...
			if (this.m_isUserMusicOn && state == 2)
			{
