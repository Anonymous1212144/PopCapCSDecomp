					...
					if (flag2)
					{
						...
						while (num3 != 9)
						{
							...
							for (int m = 0; m < num16; m++)
							{
								...
								{
								case 3:
									layer.AddAnchorPoint(num18 + k, (float)num24, (float)num25);
									break;
								case 4:
									layer.AddPosition(num18 + k, (float)num24, (float)num25);
									break;
								case 5:
									layer.AddScale(num18 + k, (float)num24 / 100f, (float)num25 / 100f);
									break;
								case 6:
									layer.AddRotation(num18 + k, (float)num24 * 3.14159f / 180f);
									break;
								case 7:
									layer.AddOpacity(num18 + k, (float)num24 / 100f);
									break;
								}
							}
							parseByteArray.readInt32(ref num3);
