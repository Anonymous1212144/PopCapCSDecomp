...
namespace JeffLib
{
	public static class CommonGraphics
	{
		...
		{
			CommonGraphics.DrawCircle(g, center_x, center_y, r, num_segments, true, 6.28318548f);
		}

		public static void DrawCircle(Graphics g, float center_x, float center_y, float r, int num_segments, bool fill)
		{
			CommonGraphics.DrawCircle(g, center_x, center_y, r, num_segments, fill, 6.28318548f);
		}
