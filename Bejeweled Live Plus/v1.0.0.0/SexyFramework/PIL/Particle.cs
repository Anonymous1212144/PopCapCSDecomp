...
namespace SexyFramework.PIL
{
	public class Particle : MovableObject
	{
		...
		public virtual void Draw(Graphics g, float alpha_pct, Color tint_color, float tint_strength, float scale)
		{
		...
		public virtual void Draw(Graphics g, float alpha_pct, Color tint_color, float tint_strength)
		{
