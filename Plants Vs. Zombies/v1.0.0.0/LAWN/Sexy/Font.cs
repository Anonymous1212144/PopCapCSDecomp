...
namespace Sexy
{
	internal class Font
	{
		...
		public void DrawStringLayer(Graphics g, int theX, int theY, string theString, Color theColor, int layer)
		{
			...
			Vector2 vector2 = vector + this.mOffsets[layer] * this.mScaleX * FrameworkConstants.Font_Scale;
			if (!string.IsNullOrEmpty(theString) && this.mCharOffsets.ContainsKey(theString.get_Chars(0)))
			{
				vector2.X -= this.mCharOffsets[theString.get_Chars(0)].X * this.mScaleX * FrameworkConstants.Font_Scale;
			}
			for (int i = 0; i < theString.Length; i++)
			{
				...
				else
				{
					...
					{
						Vector2 vector3 = vector2 + this.mCharOffsets[theString.get_Chars(i)] * this.mScaleX * FrameworkConstants.Font_Scale;
		...
		public void DrawString(Graphics g, int theX, int theY, StringBuilder theString, Color theColor)
		{
			...
			for (int i = 0; i < this.mFonts.Count; i++)
			{
				...
				{
					Vector2 vector2 = vector + this.mOffsets[i] * this.mScaleX * FrameworkConstants.Font_Scale;
					for (int j = 0; j < theString.Length; j++)
					{
						if (char.IsWhiteSpace(theString.get_Chars(j)))
						{
						...
						else
						{
							...
							{
								Vector2 vector3 = vector2 + this.mCharOffsets[theString.get_Chars(j)] * this.mScaleX * FrameworkConstants.Font_Scale;
