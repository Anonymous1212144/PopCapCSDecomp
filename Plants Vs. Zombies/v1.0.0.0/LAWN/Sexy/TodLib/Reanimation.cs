...
namespace Sexy.TodLib
{
	internal class Reanimation
	{
		...
		private bool DrawTrack(Graphics g, int theTrackIndex, int theRenderGroup)
		{
			...
			matrix.M11 = num7 * this.mOverlayMatrix.mMatrix.M11 + num8 * this.mOverlayMatrix.mMatrix.M21;
			matrix.M12 = num7 * this.mOverlayMatrix.mMatrix.M12 + num8 * this.mOverlayMatrix.mMatrix.M22;
			matrix.M13 = 0f;
			matrix.M14 = 0f;
			matrix.M21 = num9 * this.mOverlayMatrix.mMatrix.M11 + num10 * this.mOverlayMatrix.mMatrix.M21;
			matrix.M22 = num9 * this.mOverlayMatrix.mMatrix.M12 + num10 * this.mOverlayMatrix.mMatrix.M22;
			matrix.M23 = 0f;
			matrix.M24 = 0f;
			matrix.M31 = 0f;
			matrix.M32 = 0f;
			matrix.M33 = 1f;
			matrix.M34 = 0f;
			matrix.M41 = num11 * this.mOverlayMatrix.mMatrix.M11 + num12 * this.mOverlayMatrix.mMatrix.M21 + this.mOverlayMatrix.mMatrix.M41 + (float)g.mTransX + reanimatorTrackInstance.mShakeX - 0.5f;
			matrix.M42 = num11 * this.mOverlayMatrix.mMatrix.M12 + num12 * this.mOverlayMatrix.mMatrix.M22 + this.mOverlayMatrix.mMatrix.M42 + (float)g.mTransY + reanimatorTrackInstance.mShakeY - 0.5f;
			matrix.M43 = 0f;
			matrix.M44 = 1f;
			Reanimation.tempMatrix = matrix;
			if (theTrackIndex == 9)
			{
				int num13 = 0;
				num13++;
		...
		public void GetAttachmentOverlayMatrix(int theTrackIndex, out SexyTransform2D theOverlayMatrix)
		{
			...
			Matrix.Invert(ref this.basePose.mMatrix, ref this.aBasePoseMatrix);
			theOverlayMatrix = Reanimation.identity;
			Matrix matrix = default(Matrix);
			matrix.M11 = this.aBasePoseMatrix.M11 * num + this.aBasePoseMatrix.M12 * num3;
			matrix.M12 = this.aBasePoseMatrix.M11 * num2 + this.aBasePoseMatrix.M12 * num4;
			matrix.M13 = 0f;
			matrix.M14 = 0f;
			matrix.M21 = this.aBasePoseMatrix.M21 * num + this.aBasePoseMatrix.M22 * num3;
			matrix.M22 = this.aBasePoseMatrix.M21 * num2 + this.aBasePoseMatrix.M22 * num4;
			matrix.M23 = 0f;
			matrix.M24 = 0f;
			matrix.M31 = 0f;
			matrix.M32 = 0f;
			matrix.M33 = 1f;
			matrix.M34 = 0f;
			matrix.M41 = this.aBasePoseMatrix.M41 * num + this.aBasePoseMatrix.M42 * num3 + mTransX;
			matrix.M42 = this.aBasePoseMatrix.M41 * num2 + this.aBasePoseMatrix.M42 * num4 + mTransY;
			matrix.M43 = 0f;
			matrix.M44 = 1f;
			this.tempOverlayMatrix = matrix;
			Matrix mMatrix = default(Matrix);
			mMatrix.M11 = this.tempOverlayMatrix.M11 * this.mOverlayMatrix.mMatrix.M11 + this.tempOverlayMatrix.M12 * this.mOverlayMatrix.mMatrix.M21;
			mMatrix.M12 = this.tempOverlayMatrix.M11 * this.mOverlayMatrix.mMatrix.M12 + this.tempOverlayMatrix.M12 * this.mOverlayMatrix.mMatrix.M22;
			mMatrix.M13 = 0f;
			mMatrix.M14 = 0f;
			mMatrix.M21 = this.tempOverlayMatrix.M21 * this.mOverlayMatrix.mMatrix.M11 + this.tempOverlayMatrix.M22 * this.mOverlayMatrix.mMatrix.M21;
			mMatrix.M22 = this.tempOverlayMatrix.M21 * this.mOverlayMatrix.mMatrix.M12 + this.tempOverlayMatrix.M22 * this.mOverlayMatrix.mMatrix.M22;
			mMatrix.M23 = 0f;
			mMatrix.M24 = 0f;
			mMatrix.M31 = 0f;
			mMatrix.M32 = 0f;
			mMatrix.M33 = 1f;
			mMatrix.M34 = 0f;
			mMatrix.M41 = this.tempOverlayMatrix.M41 * this.mOverlayMatrix.mMatrix.M11 + this.tempOverlayMatrix.M42 * this.mOverlayMatrix.mMatrix.M21 + this.mOverlayMatrix.mMatrix.M41;
			mMatrix.M42 = this.tempOverlayMatrix.M41 * this.mOverlayMatrix.mMatrix.M12 + this.tempOverlayMatrix.M42 * this.mOverlayMatrix.mMatrix.M22 + this.mOverlayMatrix.mMatrix.M42;
			mMatrix.M43 = 0f;
			mMatrix.M44 = 1f;
			theOverlayMatrix.mMatrix = mMatrix;
		}
		...
		{
			Matrix matrix = default(Matrix);
			matrix.M11 = (float)Math.Cos((double)(theTransform.mSkewX * -(double)TodCommon.DEG_TO_RAD)) * theTransform.mScaleX;
			matrix.M12 = (float)(-(float)Math.Sin((double)(theTransform.mSkewX * -(double)TodCommon.DEG_TO_RAD))) * theTransform.mScaleX;
			matrix.M13 = 0f;
			matrix.M14 = 0f;
			matrix.M21 = (float)Math.Sin((double)(theTransform.mSkewY * -(double)TodCommon.DEG_TO_RAD)) * theTransform.mScaleY;
			matrix.M22 = (float)Math.Cos((double)(theTransform.mSkewY * -(double)TodCommon.DEG_TO_RAD)) * theTransform.mScaleY;
			matrix.M23 = 0f;
			matrix.M24 = 0f;
			matrix.M31 = 0f;
			matrix.M32 = 0f;
			matrix.M33 = 1f;
			matrix.M34 = 0f;
			matrix.M41 = theTransform.mTransX;
			matrix.M42 = theTransform.mTransY;
			matrix.M43 = 0f;
			matrix.M44 = 1f;
			theMatrix = matrix;
		}
		...
		public void GetTrackMatrix(int theTrackIndex, ref SexyTransform2D theMatrix)
		{
			...
			if (image != null && num >= 0)
			{
				int celWidth = image.GetCelWidth();
				int celHeight = image.GetCelHeight();
				Matrix.CreateTranslation((float)celWidth * 0.5f, (float)celHeight * 0.5f, 0f, ref Reanimation.tempMatrix);
			}
			else if (reanimatorTransform.mFont != null && !string.IsNullOrEmpty(reanimatorTransform.mText))
			{
				Matrix.CreateTranslation(0f, (float)reanimatorTransform.mFont.mAscent, 0f, ref Reanimation.tempMatrix);
			}
