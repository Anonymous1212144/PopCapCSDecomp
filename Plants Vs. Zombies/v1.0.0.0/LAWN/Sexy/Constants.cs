...
namespace Sexy
{
	internal class Constants : FrameworkConstants
	{
		public static void Load320x480()
		{
			...
			Constants.Board_Cel_Y_Values_Normal = new int[] { 80, 177, 280, 380, 470, 570, 610 };
			Constants.Board_Cel_Y_Values_Pool = new int[] { 80, 170, 275, 360, 447, 522, 610 };
			Constants.Board_Cel_Y_Values_ZenGarden = new int[] { 80, 177, 280, 380, 470, 570, 610 };
		...
		public static void Load480x800()
		{
			...
			Constants.Board_Cel_Y_Values_Normal = new int[] { 80, 177, 280, 380, 470, 570, 610 };
			Constants.Board_Cel_Y_Values_Pool = new int[] { 80, 170, 275, 360, 447, 522, 610 };
			Constants.Board_Cel_Y_Values_ZenGarden = new int[] { 125, 225, 335, 455, 560, 750, 750 };
		...
		public static DisplayOrientation SupportedOrientations = 3;
