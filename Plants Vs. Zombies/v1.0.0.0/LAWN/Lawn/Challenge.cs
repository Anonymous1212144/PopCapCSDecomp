...
namespace Lawn
{
	internal class Challenge : StoreListener
	{
		...
		public void InitZombieWaves()
		{
			...
			{
				ZombieType[] array4 = new ZombieType[] { ZombieType.ZOMBIE_POGO };
			...
			{
				ZombieType[] array14 = new ZombieType[] { ZombieType.ZOMBIE_BALLOON };
		...
		private int[] aDoubleChance = new int[] { 0, 30, 10, 10, 15, 18 };
		...
		private int[] aPailChance = new int[] { 0, 0, 0, 10, 15, 15 };

		private int[] aConeChance = new int[] { 0, 0, 30, 30, 30, 30 };
	}
}
