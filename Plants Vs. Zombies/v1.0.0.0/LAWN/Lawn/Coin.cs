	...
	internal class Coin : GameObject
	{
		...
		public void CoinInitialize(int theX, int theY, CoinType theCoinType, CoinMotion theCoinMotion)
		{
			...
			else if (this.mType == CoinType.COIN_PRESENT_PLANT)
			{
				...
				{
					int[] array = new int[] { 0, 1, 2, 3, 7, 4, 5, 6 };
				...
				{
					int[] array2 = new int[] { 8, 9, 10, 11, 12, 13, 14, 15 };
				...
				{
					int[] array3 = new int[] { 16, 17, 18, 19, 20, 21, 22, 23 };
				...
				{
					int[] array4 = new int[] { 24, 25, 26, 27, 28, 29, 30, 31 };
				...
				{
					int[] array5 = new int[] { 32, 34, 35, 36, 37, 39 };
		...
		public void FanOutCoins(CoinType theCoinType, int theNumCoins)
		{
			...
			{
				float num = 1.57079637f + 3.14159274f * (float)(i + 1) / (float)(theNumCoins + 1);
