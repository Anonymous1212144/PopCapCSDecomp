			...
			for (int i = 0; i < Constants.GRIDSIZEX; i++)
			{
				for (int j = 0; j < 7; j++)
				{
					...
					if (num != 0)
					{
						...
						int num6 = 255 - num2;
						float num7 = (float)this.mMainCounter * 3.14159274f * 2f / 900f;
						float num8 = (float)this.mMainCounter * 3.14159274f * 2f / 500f;
						float num9 = 3f * (float)i * 3.14159274f * 2f / (float)Constants.GRIDSIZEX;
						float num10 = 3f * (float)j * 3.14159274f * 2f / 7f;
