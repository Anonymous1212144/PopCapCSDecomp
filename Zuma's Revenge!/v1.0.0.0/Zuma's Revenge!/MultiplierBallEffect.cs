...
namespace ZumasRevenge
{
	public class MultiplierBallEffect
	{
		protected void InitSpawnEffects()
		{
			...
			System system = this.mSpawnEffect.mRings;
			...
			particleType.mEmitterAttachPct = 1f;
			particleType.mColorKeyManager.AddColorKey(0f, Color.White);
			particleType.mColorKeyManager.AddColorKey(ZumasRevenge.Common._M(0.9f), Color.White);
			particleType.mColorKeyManager.AddColorKey(1f, Color.Black);
			particleType.mAlphaKeyManager.AddAlphaKey(0f, 255);
		...
		protected void InitTriggeredEffects()
		{
			...
			System system = this.mTriggeredEffect.mRings;
			...
			particleType.mInitAngle = 3.14159274f;
			...
			particleType.mColorKeyManager.AddColorKey(ZumasRevenge.Common._M(0.375f), new Color(98, 254, 255));
			particleType.mColorKeyManager.AddColorKey(ZumasRevenge.Common._M(0.675f), new Color(255, 101, 206));
			...
			Vector2 c;
			c..ctor(num2 * (float)ZumasRevenge.Common._M(150) + this.mMultBall.GetX(), num3 * (float)ZumasRevenge.Common._M1(250) + this.mMultBall.GetY());
